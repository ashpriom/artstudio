...
<div id="col2"> <!-- column 2: start -->
  ...
  <div id="share-plugins">
    ...
    <div id="twitter">
      ...
      <a href="https://twitter.com/SynStudio" class="twitter-follow-button" data-show-screen-name="true" data-show-count="false">Follow</a><script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script>
