...
<div id="content" class="classes-byCategory">
	...
	<?php while ( have_posts() ) : the_post(); ?>
    	...
    	<?php
			...
			$fields = CFS()->get('categoryloop');
			foreach ($fields as $field) { ?>
				<div class="info-box1Wrapper">
					<div class="info-box1">
						<h2>Foundations of painting</h2>
						<div class="image">
							<a href="/foundations-of-painting-2/">
								<img title="" src="http://synstudio.staging.wpengine.com/wp-content/uploads/2015/02/DSC_8854-2.jpg" alt="" width="278">
							</a>
						</div>
						<ul>
							<li>Level: BEGINNER</li>
							<li>Learn the fundamentals of colour theory</li>
							<li>Familiarize yourself with essential oil techniques</li>
							<li>Paint still lives and live models</li>
						</ul>
					</div>
					<a class="lnk-readMore" href="/foundations-of-painting-2/">More Information</a>
				</div>
			<?php }
			*/
		?>	
