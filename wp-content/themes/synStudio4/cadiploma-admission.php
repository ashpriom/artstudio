...
<style type="text/css">
    #mc_embed_signup{background:#fff; clear:left; font:14px Gotham, Arial, sans-serif; }
    /* Add your own MailChimp form style overrides in your site stylesheet or in this style block.
       We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */
</style>
<div id="mc_embed_signup" class="form11">
...
<div class="mc-field-group input-group">
    ...
    <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_23c298529438530e62af0db46_e8c037fe10" tabindex="-1" value=""></div>
    <div class="clear" style="width:100%;text-align:center;"><input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
    </div>
</form>
</div>
