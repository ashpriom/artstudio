...
<div id="content" class="general-page"> <!-- Interview content: start -->
  <div id="col1">
    ...
    <div class="podcast-boxWrapper">
      ...
      <?php the_content(); // This is the whole interview post, there rest is for the content below post.
      if ($currentLang == "en") { ?>
      <div class='mailcall1'>
		    <h2>Even More…</h2>
      ...
      <div class='mailcall1'>
        ...
        <div class='mailform1'>
          <!--<form action="//synstudio.us2.list-manage.com/subscribe/post?u=23c298529438530e62af0db46&amp;id=623da952bd" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            ...
            <div class="clear"><input type="submit" class="button" id="mc-embedded-subscribe" name="subscribe" value="Abonnez-vous" onclick="_gaq.push(['_trackEvent', 'Newsletter EN', 'Join Our Newsletter', 'Subscribe']);" ></div>
          </form>-->          
          <div id="mc_embed_signup"> <!-- Begin MailChimp Signup Form -->
            ...
            <div class="mc-field-group input-group">
                <ul><li><input type="checkbox" value="1" checked="true" name="group[9197][1]" id="mce-group[9197]-9197-0"><label for="mce-group[9197]-9197-0">Podcasts, vidéos, tutoriaux, entrevues et articles de Syn Studio</label></li>
