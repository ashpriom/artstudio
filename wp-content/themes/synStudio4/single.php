...
if ($postID==10320 || $postID==12105 || $postID==12106) { get_header("masterClass"); }
...
if(in_category(4) || in_category(48)){ // This is for all posts under "classes (cours)" category
	if ($postID==12105 || $postID==12106 || $postID==12457 || $postID==12458 || $postID==12459 || $postID==12460) { include(TEMPLATEPATH . '/masterclass.php'); }
