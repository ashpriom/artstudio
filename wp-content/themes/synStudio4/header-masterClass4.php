 ...
 <!-- header: start -->
	<div id="header">
 	<!-- banner: start -->
				<?php
				if ($currentLang == "fr") {
					 echo "<img src='http://synstudio.ca/wp-content/uploads/2015/05/Syn_MIM_Partnership_Banner_v01a_French.jpg' alt='Shaddy Safadi & Eytan Zana - Concept Art Masterclass' width='1000' />";
				}
				else {
