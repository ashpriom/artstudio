...
<html <?php language_attributes(); ?>>
	...
	<body>
		...
		<?php
			if ($currentLang == "fr") { ?>
					<img src="<?php bloginfo('url'); ?>/../wp-content/uploads/2016/01/gathering-banner-wacom-fr.jpg" alt="SYN STUDIO - GATHERING OF MASTERS 2016" width="1000" />
				<?php }
				else { ?>
					<img src="<?php bloginfo('url'); ?>/wp-content/uploads/2016/01/gathering-banner-wacom-en.jpg" alt="SYN STUDIO - GATHERING OF MASTERS 2016" width="1000" />
				<?php } ?>
