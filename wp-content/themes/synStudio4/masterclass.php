 	...
 	<div id="col1" onmouseover="hideDetails();"> <!-- column 1: start -->
   		...
   		<div id="welcomeHero">
			...
			for (var i2=1; i2<=totalSlides2; i2++){
				...
				if (i2==1) {
					var listItem = "<li class='p" + i2 + " active'><iframe id=\"ssgmplayer\" style=\"position: relative; height: 100%; width: 100%;\" src=\"https://www.youtube.com/embed/THWecUL38uQ?autoplay=1&rel=0&enablejsapi=1\" frameborder=\"0\" allowfullscreen=\"allowfullscreen\"></iframe></li>";
				}
				else {
