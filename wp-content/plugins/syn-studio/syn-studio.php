...
function main_menu(){
	...
	add_submenu_page( 'syn-studio/inforoom.php','Syn Studio Options', 'Syn Studio Options', 'manage_options', 'syn-studio/synstudio-options.php', 'SynOptions');
...
function SynValidate($input){
	...
	if(!preg_match('/^[a-zA-Z0-9\s.]{5,32}$/i', $options['text_string'])) {
		$options['text_string'] = '';
	}
	return $options;
}
