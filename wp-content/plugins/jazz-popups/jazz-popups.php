...
//    die;
    ...
    $esc_key = sanitize_text_field($_REQUEST['esc_key']);
    $ul = '0';
    $user_id = $ul;
    if ($radio_value == 'text') {
        $type = 0;
...
function test_init() {
    ...
    $esc_key[$myrows[0]->esc_key] = ' selected="selected"';
    ...
    ?>
                                                ...
                                                <div class="col">
                                                    <div class="where" style="margin-bottom:7px;">
                                                        <a href="https://www.paypal.com/cgi-bin/webscr?business=billing@purelogics.net&cmd=_xclick">
    ...
    <?php /* ?><div class="inner-field">
      ...
      <option <?php echo $position[3]; ?> value="3">Center</option>
                                                                ...
                                                                <div class="field-wrap">
                                                                    <div class="form-group">
                                                                        <select class="form-control" name="esc_key" id="wp-esc_key">
                                                                            <option <?php echo @$esc_key[1]; ?> value="1">Enable Escape Key</option>
                                                                            <option <?php echo @$esc_key[2]; ?> value="2">Disable Escape Key</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
